...
Hi there, and welcome! This repository is a collection of projects from my journey toward a Master of Science in Data Analytics (MSDA) at Western Governors University (WGU). I'm excited to share how I've used data analysis tools, including SQL, Python, and Tableau, to take on practical business problems.
...
| [Multiple Linear Regression](https://josno.github.io/multi-linear-notebook/)                                                        | Evaluated linear regression models to predict length of hospital stay based on selected patient attributes              |
| [Multiple Logistic Regression](https://josno.github.io/multi-logistic-notebook/)                                                    | Evaluated logistic regression models to predict customer telecommunications attributes against customer churn           |
