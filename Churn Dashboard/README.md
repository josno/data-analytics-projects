...
1.  Download a copy of the dashboard in this folder
2.  Explore it in realtime here (you will need the password: xx)
...
![Filtered Data All](screenshots/Filter1.png)

#### Filtered - Churned Customers

![Filtered Data with churned customers only](screenshots/Filter2.png)

#### Filtered - Non-Churned Customers

![Filtered Data with non-churned customers only](screenshots/Filter3.png)

### Map Data

![Price difference monthly charge by state](screenshots/pricing_state.png)

### Dynamic Zone Visibility

#### By Region

![Churn rate by region](screenshots/DZV_region.png)

#### By State

![Churn rate by state](screenshots/DZV_state.png)
